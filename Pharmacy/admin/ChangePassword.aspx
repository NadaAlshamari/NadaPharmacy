...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:ChangePassword ID="ChangePassword1" runat="server" Font-Bold="True" ForeColor="#336699" OnChangedPassword="ChangePassword1_ChangedPassword" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em">
