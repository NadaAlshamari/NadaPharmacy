<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="showRoles.aspx.cs" Inherits="Pharmacy.admin.showRoles" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
    <h3 style="font-family: 'Arabic Typesetting'; font-size: x-large; color: #336699;"> <strong><em style="font-style: oblique">User Role Management Conso<b>le</b></em></strong></h3>
    <div>
        <table border="1">
            <tr>
                <th style="font-family: 'Arabic Typesetting'">
                    <span style="font-size: medium">Roles 
                </th>
                <th style="font-family: 'Arabic Typesetting'">
                    Users
                </span>
                ...
                <th style="font-family: 'Arabic Typesetting'">
                    ...
                    Text="Link User Role" OnClick="btnUserRoleAssign_Click" Width="120px" style="font-size: medium" />
                </th>
            </tr>
            <tr>
                <td valign="top" style="font-family: 'Arabic Typesetting'">
                 ...
                 <td valign="top" style="font-family: 'Arabic Typesetting'">
                    <asp:Button ID="btnUnlinkUserRoles" runat="server" OnClick="btnUnlinkUserRoles_Click" Text="Unlink User Role" Width="120px" style="font-size: medium" />
                </td>
            </tr>
            <tr>
                <td colspan="2" style="font-family: 'Arabic Typesetting'; font-size: medium;">
                    &nbsp;</td>
                <td style="font-family: 'Arabic Typesetting'">
                     <asp:Button ID="btnDeleteRoles" runat="server" OnClick="btnDeleteRoles_Click" Text="Delete Roles" Width="120px" style="font-size: medium" />
                </td>
            </tr>
            <tr>
                <td colspan="2" style="font-family: 'Arabic Typesetting'; font-size: medium;">
                    &nbsp;</td>
                <td style="font-family: 'Arabic Typesetting'">
                    <asp:Button ID="btnDeleteUsers" runat="server" OnClick="btnDeleteUsers_Click" Text="Delete Users" Width="120px" style="font-size: medium" />
                </td>
            </tr>
        </table>
    </div>
