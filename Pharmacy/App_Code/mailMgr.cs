...
public class mailMgr : MailMessage
{
     ...
     public mailMgr()
    {
        ...
        myTo = "nadanezal.alshammari@gmail.com";
        mySubject = " pharmacy is now closer to you ";
        myIsBodyHtml = true;
        ...
        myPortNumber = 587;
        myEnableSSL = true;
        myUserName = "appdev4y@gmail.com";//"ajalzahrani1@gmail.com";
        myPassword = "aowhaqeyqiarghyr";//"atheer@22";
    }
    // use this one 
